...
from .exercise_utils import (
    ...
    calcular_media_series, calcular_volume_total
)
...
from .format_utils import (  # <--- NOVO IMPORT
...
__all__ = [
    ...
    'get_versoes_treino', 'get_exercicios_por_versao',
    'get_ultimas_series',
    'formatar_data', 'formatar_data_para_input', 'data_atual_formatada', 'data_atual_iso'  # <--- NOVOS
]